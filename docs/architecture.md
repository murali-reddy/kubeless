...
Use of Kubernetes CRD's and CRD controllers forms the core design tenet of Kubeless. Use of seperate CRD's for functions and triggers provides clear seperation of concerns. Use of seperate CRD controllers keeps the code decoupled and modular.
